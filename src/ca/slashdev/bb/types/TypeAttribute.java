...
public class TypeAttribute extends EnumeratedAttribute {
   ...
   public static TypeAttribute fromAppDescriptor(String value) {
      String typeValue = null;
      if ("BlackBerry Application".equals(value)) {
         typeValue = CLDC;
      } else if ("MIDlet".equals(value)) {
         typeValue = MIDLET;
      } else if ("Library".equals(value)) {
         typeValue = LIBRARY;
      }
